...
class Patient(models.Model): 
    ...
    address = models.CharField(max_length=40, help_text = 'Enter your street address')
    city = models.CharField(default="null", max_length=20, help_text = "Enter your city of residence")
    state = models.CharField(default = "null", max_length=20, help_text = "Enter your state of residence.")
    zip_code = models.PositiveIntegerField(default = 1, help_text = 'Enter your zipcode')
