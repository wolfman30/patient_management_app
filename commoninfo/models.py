...
class Patient(models.Model): 
    ...
    class Meta: 
        ordering = ['unique_ID', 'first_Name', 'last_Name', 'date_of_birth', 'reason_for_visit']
    ...
    def __str__(self): 
        return f'{self.unique_ID}, {self.first_Name}, {self.last_Name}, {self.date_of_birth}, {self.reason_for_visit}'